...
from .views import CategoryApiView, OrderApiView, ProductApiView, ProductByCategory

urlpatterns = [
    path('api/categories', CategoryApiView.as_view(), name='category_list'),
    path('api/products', ProductApiView.as_view(), name='product_list'),
    path('api/products/category/<str:query>/', ProductByCategory.as_view(), name='product_category_list'),
